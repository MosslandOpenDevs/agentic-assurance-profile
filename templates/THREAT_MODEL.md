...
> **Placement:** Copy this file to `assurance/THREAT_MODEL.md` in the adopting repository, or to the path recorded under `paths.threat_model` in the configured adoption declaration (default: `.agentic-assurance/adoption.yaml`). Replace every `REPLACE_WITH_` placeholder.
>
