...
| Version | Supported |
|---|---|
| `v0.5.1` | Yes — current release |
| `v0.5.0` | Yes — previous release; upgrade at convenience (v0.5.1 adds revised adoption guidance and the non-normative v0.5-track closeout; it changes no adopter obligation or runtime behavior, so no migration is required) |
